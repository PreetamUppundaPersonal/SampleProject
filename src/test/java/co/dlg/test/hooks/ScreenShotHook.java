package co.dlg.test.hooks;

/**
 * Created by Preetam on 5/12/2017.
 */
...
public class ScreenShotHook extends BaseStepDef {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(co.dlg.test.hooks.ScreenShotHook.class);
